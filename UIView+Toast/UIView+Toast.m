...
// shadow appearance
static const CGFloat CSToastShadowOpacity       = 0.15f;
static const CGFloat CSToastShadowRadius        = 6.0;
static const CGSize  CSToastShadowOffset        = { 0, 4.0 };
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    ...
    // default to bottom
    return CGPointMake(self.bounds.size.width/2, (self.bounds.size.height - (toast.frame.size.height / 2)) - CSToastVerticalPadding - 44.f);
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor colorFromHexString:@"#F88C92"] colorWithAlphaComponent:CSToastOpacity];
    ...
    if (message != nil) {
        ...
        messageLabel.textAlignment = NSTextAlignmentCenter; // dsmo
